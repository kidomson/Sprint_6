class TestData:
    test_data_user1 = ['Матвей', 'Зуев', 'Невский проспект, 1', 'Фрунзенская', '+79999999999', '22.05.2024',
                 'Комментарий']

    test_data_user2 = ['Геннадий', 'Олег', 'Дыбенко 1', 'Лубянка', '+79998889988', '21.05.2024',
                 'Коммент']
